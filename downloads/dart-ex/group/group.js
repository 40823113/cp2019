...
(function dartProgram() {
  ...
  F = {
    ...
    Grouping: function() {
      var t1 = {},
        t2 = $.$get$output();
      (t2 && C.LabelElement_methods).setInnerHtml$1(t2, "");
      t2 = $.$get$grpNum().value;
      if (t2 !== "")
        $.num = P.int_parse(t2);
      else
      ...
      t1.i = null;
      t1.gpList = [];
      W.HttpRequest_getString(t2).then$1$1(new F.Grouping_closure(t1, []), null);
    },
    ...
    call$1: function(resp) {
      ...
      while (t3 < studList.length) {
        ...
        if (C.JSInt_methods.$mod(t3, t4) === 0) {
          t1.gpList = [];
          t3 = $.$get$output();
          (t3 && C.LabelElement_methods).setInnerHtml$1(t3, J.$add$ansx(t3.innerHTML, C.JSString_methods.$mul("=", 20) + "<br />"));
          t3 = $.$get$output();
          (t3 && C.LabelElement_methods).setInnerHtml$1(t3, J.$add$ansx(t3.innerHTML, "group " + t1.gth + " :<br />"));
          t3 = $.$get$output();
          (t3 && C.LabelElement_methods).setInnerHtml$1(t3, J.$add$ansx(t3.innerHTML, J.$add$ansx(C.JSArray_methods.$index(studList, t1.i), "<br />")));
          ...
          (t4 && C.LabelElement_methods).setInnerHtml$1(t4, J.$add$ansx(t5, J.$add$ansx(studList[t3], "<br />")));
          C.JSArray_methods.add$1(t1.gpList, C.JSArray_methods.$index(studList, t1.i));
        }
        t3 = t1.i;
        t4 = $.num;
      ...
      t1 = $.$get$output();
      (t1 && C.LabelElement_methods).setInnerHtml$1(t1, J.$add$ansx(t1.innerHTML, P.IterableBase_iterableToFullString(t2, "[", "]") + "<br />"));
    },
    $signature: 22
  };
  (function aliases() {
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "output", "$get$output", function() {
      return H.interceptedTypeCheck(W.querySelector("#output"), "$isLabelElement");
    });
  })();
