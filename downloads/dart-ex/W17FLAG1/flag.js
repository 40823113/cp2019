...
(function dartProgram() {
  ...
  F = {
    main: function() {
      ...
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new F.main_closure(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#usa"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new F.main_closure0(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#France"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new F.main_closure1(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#Russia"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new F.main_closure2(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#Germany"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new F.main_closure3(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#Netherlands"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new F.main_closure4(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#Japan"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new F.main_closure5(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#ENGLAND"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new F.main_closure6(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t1 = J.get$onClick$x(t1.querySelector("#button"));
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new F.main_closure7(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
