...
(function dartProgram() {
  ...
  F = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new F.main_closure(tempInput), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    ...
    call$1: function(e) {
      ...
      if (type === "k") {
        ...
        if (typeof number !== "number")
          return number.$mul();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 2.2046223, 2) + " \u78c5");
      } else {
        ...
        if (type === "l") {
          ...
          if (typeof number !== "number")
            return number.$mul();
          t1.setInnerHtml$1(output, t2 + C.JSNumber_methods.toStringAsFixed$1(number * 2.2046223, 2) + " \u516c\u65a4");
        } else
          t1.setInnerHtml$1(output, "\u8acb\u8f38\u5165\u6578\u5b57\u52a0\u4e0a kg \u6216 lb!");
      }
      return;
    },
    $signature: 18
...
//# sourceMappingURL=lbtokg.js.map
